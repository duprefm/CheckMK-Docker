...
custom_checks = [
{'id': 'ac9f8092-67c2-4a17-a350-28f78033e3b5', 'value': {'service_description': 'CheckBackupError', 'freshness': {'interval': 10, 'state': 2, 'output': 'Check result did not arrive in time'}}, 'condition': {}, 'options': {'description': 'Check-Backup-Error'}},
] + custom_checks
...
{'id': '99f40997-876a-4229-8180-c0f590ddea4d', 'value': '0', 'condition': {}, 'options': {'description': 'Enable/disable active checks for services'}},
] + extra_service_conf['active_checks_enabled']
